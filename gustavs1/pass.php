...
<div class="container">
    ...
    <div class="banner">
        ...
        <div class="info">
            <p>Введите номер телефона, который вы указывали при регистрации. Мы вышлем на него код подтверждения для изменения пароля.</p>
        </div>
    </div>
    <div class="reg-form">
        <div class="row clear big-form">
            ...
            <div class="col-6">
                <div class="buttons">
                    <a href="pass-2.php" class="button big border arrow">Далее</a>
                </div>
            </div>
        </div>
